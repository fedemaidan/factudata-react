                  ...
                  <FormGroup>
                    <Grid container spacing={2}>
                      {emprendimientos.map((emprendimiento) => (
                        <Grid item xs={12} sm={6} md={4} key={emprendimiento}>
                          <FormControlLabel
                            control={
                              <Checkbox
                                checked={formData.emprendimientos.includes(emprendimiento)}
                                onChange={handleCheckboxChange('emprendimientos', emprendimiento)}
                                sx={{
                                  '&.Mui-checked': {
                                    color: 'primary.main',
                                  },
                ...
                <CardContent sx={{ p: 4 }}>
                  ...
                  <Alert severity="info" sx={{ mb: 3, borderRadius: 2 }}>
                    <Typography variant="body2">
                      Agrega permisos específicos para este usuario, además de los que ya tiene por su rol.
                    </Typography>
                  </Alert>
