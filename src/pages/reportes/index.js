...
const TEMPLATES = [
  {
    ...
    descripcion: 'Resumen ejecutivo de obra con ingresos, egresos, detalle por categoría/subcategoría y presupuesto vs ejecución',
    ...
    layout: [
      {
        ...
        metricas: [
          ...
          { id: 'saldo', titulo: 'Saldo', operacion: 'saldo_neto', campo: 'total', formato: 'currency', color: 'warning' },
        ],
      },
      {
        ...
        filtro_tipo: 'ingreso',
        columnas_visibles: ['fecha_factura', 'tipo', 'proyecto_nombre', 'monto_display', 'moneda', 'notas'],
        page_size: 25,
        resumen_desplegable: true,
        resumen_titulo: 'Ingresos',
        mostrar_cantidad_resumen: false,
      },
      {
        type: 'category_subcategory_accordion',
        titulo: 'Detalle de Egresos',
        filtro_tipo: 'egreso',
        mostrar_cantidad_movimientos: false,
      ...
      },
      {
        ...
        columnas_budget: ['presupuestado', 'ejecutado', 'disponible', 'porcentaje'],
        alerta_sobreejecucion: true,
        incluir_sin_presupuesto: false,
        mostrar_desglose_presupuestos: true,
      },
      {
        type: 'budget_vs_actual',
        titulo: 'Presupuestos por Proveedores',
        agrupar_por: 'proveedor',
        mostrar_tipo: 'egreso',
        presupuestos_con_campo: 'proveedor',
        columnas_budget: ['presupuestado', 'ejecutado', 'disponible', 'porcentaje'],
        alerta_sobreejecucion: true,
        incluir_sin_presupuesto: false,
